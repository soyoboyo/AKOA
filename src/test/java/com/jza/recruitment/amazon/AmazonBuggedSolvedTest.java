...
public class AmazonBuggedSolvedTest {

	@Test
	public void reverseArrayTest1() {
		int[] input = {1, 2, 3, 4, 5, 6, 7};
		int[] result = {7, 6, 5, 4, 3, 2, 1};
		Assertions.assertArrayEquals(result, AmazonBuggedSolved.reverseArray(input));
	}
	...
	public void sortArrayTest1() {
		...
		Assertions.assertArrayEquals(result, AmazonBuggedSolved.sortArray(input));
	}
	...
	public void replaceValuesTest1() {
		...
		Assertions.assertArrayEquals(result, AmazonBuggedSolved.replaceValues(input));
	}
	...
	public void countOccurrenceTest1() {
		...
		int input = 3;
		int result = 2;
		Assertions.assertEquals(result, AmazonBuggedSolved.countOccurrence(inputArr, input));
	}
	...
	public void checkGradeTest1() {
		int input = 54;
		char result = 'D';
		Assertions.assertEquals(result, AmazonBuggedSolved.checkGrade(input));
	}
	...
	public void countDigitsTest1() {
		int input = 782;
		int result = 2;
		Assertions.assertEquals(result, AmazonBuggedSolved.countDigits(input));
	}
	...
	public void printPatternTest1() {
		...
		Assertions.assertEquals("", AmazonBuggedSolved.printPattern(input));
