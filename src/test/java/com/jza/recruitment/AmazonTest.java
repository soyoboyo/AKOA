...
public class AmazonTest {
	...
	public void reverseArrayTest1() {
		...
		Assertions.assertEquals(result, Amazon.reverseArray(input));
	}
	...
	public void sortArrayTest1() {
		...
		Assertions.assertEquals(result, Amazon.sortArray(input));
	}
	...
	public void replaceValuesTest1() {
		...
		Assertions.assertEquals(result, Amazon.replaceValues(input));
	}
